...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 43c23234-5f12-4a6d-b345-4b0f6c958a4f
```

> `43c23234-5f12-4a6d-b345-4b0f6c958a4f` is the password of the certificate, you can change it to any password you want.
